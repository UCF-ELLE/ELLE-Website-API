                            ...
                            >
                                <Row>
                                    <Col>
                                        ...
                                        <p className="cta-text">
                                            {' '}
                                            Come learn a language, select your
                                            own mentor, and play to unlock
                                            unique prizes and customization!{' '}
                                        </p>
                                        <p className="cta-text">
                                            <Link
                                                href={
                            ...
                            >
                                <Row>
                                    <Col>
                                        ...
                                        <p className="cta-text">
                                            AnimELLE Crossing is an educational
                                            game with the intent to help
                                            students with their language
                                            learning journey. Students will get
                                            to play multiple mini games that are
                                            encompassed within the AnimELLE
                                            Crossing world, interact with
                                            non-playable characters, and
                                            personalize different aspects of
                                            their gameplay.
                                        </p>
                                        <p className="cta-text">
                                            <Link
                            ...
                            >
                                <Row>
                                    <Col>
                                        ...
                                        alphabet blocks. Play in endless mode or
                                        try your luck at quiz mode!
                                        <p className="cta-text">
                                            <br />
                                            <a
                            ...
                            >
                                <Row>
                                    <Col>
                                        ...
                                        <br />
                                        Play as a firefighter in this action
                                        packed game. Connect terms to their
                                        correct categories to put out fires and
                                        save the day!
                                        <p className="cta-text">
                                            <br />
                                            <a
                            ...
                            >
                                <Row>
                                    <Col>
                                        ...
                                        scene) where they learn the basic
                                        mechanics of the game and board a
                                        virtual bus. The bus will take them to a
                                        house to pack for their next trip or to
                                        the grocery store to practice food-based
                                        vocabulary.
                                        <p className="cta-text">
                                            <br />
                                            <a
