            ...
            <div className="mainDiv">
                            ...
                            <div className="col-lg-5 content">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        Play a whole suite of language learning
                                        games to learn another language!
                                    </li>
                                    <li>
                                        <i className="ion-android-checkmark-circle" />{' '}
                                        Create an account to view statistics,
                                        compare your scores, and make new
                                        language packs!
                                    </li>
                                    <li>
                                        <i className="ion-android-checkmark-circle" />{' '}
                                        Use ELLE to study for exams or conduct
                                        research of your own!
                                    </li>
                                    <li>
                                        <i className="ion-android-checkmark-circle" />{' '}
                                        Available in desktop, mobile, and
                    ...
                    <div className="container">
                        <div className="section-header">
                            ...
                            <p>
                                ...
                                the most of your ELLE experience.
                            </p>
                        </div>
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="box wow fadeInLeft">
                                    ...
                                    <p className="description">
                                        You can view a list of words from every
                                        language pack you have. You can view
                                        words, their translations, and their
                            ...
                            <div className="col-lg-6">
                                <div className="box wow fadeInRight">
                                    ...
                                    <h4 className="title">
                                        Create Language Decks
                                    </h4>
                                    <p className="description">
                                        Build a dictionary of words for any
                                        language. Play games with any decks that
                                        you create, or play games with decks
                            ...
                            <div className="col-lg-6">
                                ...
                                >
                                    ...
                                    <p className="description">
                                        ELLE makes it easy for instructors to
                                        see how you are progressing through a
                                        language. They can use your scores and
                                        sessions and to help students learn.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="row" style={{ textAlign: 'center' }}>
                    <div className="col-lg-12">
                        ...
                        <br />
                        <p>
                            ELLE is a senior design project made at the
                            University of Central Florida by undergraduate
                            students in the Computer Science capstone course.
                        </p>
                        <br />
                    </div>
                </div>
