        ...
        <div className='mainDiv'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-5 content'>
                            ...
                            <ul>
                                ...
                                <li>
                                    <i className='ion-android-checkmark-circle' /> Create an account to view statistics, compare your scores, and make
                                    new language packs!
                                </li>
                                <li>
                    ...
                    <div className='row'>
                        <div className='col-lg-6'>
                            <div className='box wow fadeInLeft galBox'>
                                ...
                                <p className='description'>
                                    You can view a list of words from every language pack you have. You can view words, their translations, and their
                        ...
                        <div className='col-lg-6'>
                            <div className='box wow fadeInRight galBox'>
                                ...
                                <p className='description'>
                                    Build a dictionary of words for any language. Play games with any decks that you create, or play games with decks
                        ...
                        <div className='col-lg-6'>
                            <div className='box wow fadeInLeft galBox' data-wow-delay='0.2s'>
                                ...
                                <p className='description'>
                                    Look at data from every session you&apos;ve ever played. See how well you do on certain languages and what words
                        ...
                        <div className='col-lg-6'>
                            <div className='box wow fadeInRight galBox' data-wow-delay='0.2s'>
                                ...
                                <p className='description'>
                                    ELLE makes it easy for instructors to see how you are progressing through a language. They can use your scores and
            ...
            <div className='row' style={{ textAlign: 'center' }}>
                <div className='col-lg-12'>
                    ...
                    <br />
                    <p>
                        ELLE is a senior design project made at the University of Central Florida by undergraduate students in the Computer Science
                        capstone course.
                    </p>
                    <br />
                </div>
