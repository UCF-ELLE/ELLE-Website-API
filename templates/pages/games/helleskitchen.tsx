...
export default function HELLEsKitchen() {
    ...
    const { unityProvider, requestFullscreen, isLoaded, sendMessage, loadingProgression, addEventListener, removeEventListener, unload } =
        useUnityContext({
            ...
            loaderUrl: '/elle/games/HELLEs-Kitchen/HELLEsKitchen-WebGL.loader.js',
            dataUrl: '/elle/games/HELLEs-Kitchen/HELLEsKitchen-WebGL.data',
            frameworkUrl: '/elle/games/HELLEs-Kitchen/HELLEsKitchen-WebGL.framework.js',
            codeUrl: '/elle/games/HELLEs-Kitchen/HELLEsKitchen-WebGL.wasm'
        });
...
HELLEsKitchen.getLayout = (page: React.JSX.Element) => <GameLayout>{page}</GameLayout>;
