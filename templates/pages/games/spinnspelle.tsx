...
export default function SpinNSpELLE() {
    ...
    const { unityProvider, requestFullscreen, isLoaded, sendMessage, loadingProgression, addEventListener, removeEventListener, unload } =
        useUnityContext({
            ...
            loaderUrl: '/elle/games/Spin-N-SpELLE/SpinNSpELLE-WebGL.loader.js',
            dataUrl: '/elle/games/Spin-N-SpELLE/SpinNSpELLE-WebGL.data',
            frameworkUrl: '/elle/games/Spin-N-SpELLE/SpinNSpELLE-WebGL.framework.js',
            codeUrl: '/elle/games/Spin-N-SpELLE/SpinNSpELLE-WebGL.wasm'
        });
...
SpinNSpELLE.getLayout = (page: React.JSX.Element) => <GameLayout>{page}</GameLayout>;
