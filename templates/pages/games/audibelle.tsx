...
export default function Audibelle() {
    ...
    const { unityProvider, requestFullscreen, isLoaded, sendMessage, loadingProgression, addEventListener, removeEventListener, unload } =
        useUnityContext({
            ...
            loaderUrl: '/elle/games/Audibelle/AudibELLE-WebGL.loader.js',
            dataUrl: '/elle/games/Audibelle/AudibELLE-WebGL.data',
            frameworkUrl: '/elle/games/Audibelle/AudibELLE-WebGL.framework.js',
            codeUrl: '/elle/games/Audibelle/AudibELLE-WebGL.wasm'
        });
        ...
        <div className='gamesBg mainDiv'>
            <div className='center-contents'>
                ...
                <video controls style={{ width: "400px", borderRadius: "8px" }}>
                    <source src="/elle/static/videos/AudibELLETutorial.mp4" type ="video/mp4" />
                </video>
            </div>
            <br />
            <br />
...
Audibelle.getLayout = (page: React.JSX.Element) => <GameLayout>{page}</GameLayout>;
