...
export default function HighriseHellep() {
    ...
    const { unityProvider, requestFullscreen, isLoaded, sendMessage, loadingProgression, addEventListener, removeEventListener, unload } =
        useUnityContext({
            ...
            loaderUrl: '/elle/games/Highrise-Hellep/HighriseHELLEp-WebGL.loader.js',
            dataUrl: '/elle/games/Highrise-Hellep/HighriseHELLEp-WebGL.data',
            frameworkUrl: '/elle/games/Highrise-Hellep/HighriseHELLEp-WebGL.framework.js',
            codeUrl: '/elle/games/Highrise-Hellep/HighriseHELLEp-WebGL.wasm'
        });
    ...
    useEffect(() => {
        if (isLoaded && !userLoading) {
            ...
            sendMessage('Manager', 'WebGLLoginAttempt', JSON.stringify({ jwt }));
        }
        ...
        <div className='gamesBg mainDiv'>
            <div className='center-contents'>
                ...
                <video controls style={{ width: "400px", borderRadius: "8px" }}>
                    <source src="/elle/static/videos/HighriseHELLEpTutorial.mp4" type ="video/mp4" />
                </video>
            </div>
            <br />
            <br />
...
HighriseHellep.getLayout = (page: React.JSX.Element) => <GameLayout>{page}</GameLayout>;
