...
export default function AdminView(props: AdminViewProps) {
    ...
    const getClasses = () => {
        axios.get('/elleapi/searchusergroups', {
    ...
    const revealClassDetails = () => {
        return (
          <Modal isOpen={classDetailModalOpen} toggle={() => setClassDetailModalOpen(!classDetailModalOpen)}>
            ...
            <ModalFooter>
              {editClass ? 
              <Button color="primary" onClick={() => updateClassName()}>Save</Button>
              : <Button color="primary" onClick={() => toggleEditClass()}>Edit</Button>}
              {' '}
              <Button color="secondary" onClick={() => deleteClass()}>Delete</Button>
            </ModalFooter>
          </Modal>
        )
    }
