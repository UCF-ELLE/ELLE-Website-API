...
export default function AddMentorQuestion({
    ...
    const submitMCQuestion = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        let answers1d = [
            e.currentTarget.answer1Text.value,
            e.currentTarget.answer2Text.value,
        ];
                                ...
                                <Col>
                                    ...
                                    answer2Text == '' ? (
                                        <Button
                                            ...
                                            block
                                        >
                                            Create (please fill in required
                                            fields)
                                        </Button>
                                    ) : (answer5Text != '' &&
                                          answer5Text.trim() == '') ||
                                      ...
                                      (answer2Text != '' &&
                                        ...
                                        <Button
                                            ...
                                            block
                                        >
                                            Create (200 character limit for
                                            question)
                                        </Button>
                                    ) : answer1Text.length > 30 ||
                                      answer2Text.length > 30 ||
                                ...
                                <Col>
                                    {questionText == '' ? (
                                        <Button
                                            ...
                                            block
                                        >
                                            Create (please fill in question
                                            text)
                                        </Button>
                                    ) : questionText.trim() == '' &&
                                      questionText != '' ? (
