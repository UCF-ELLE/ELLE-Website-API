...
export default function TermBarChart({ termStats, threshold }: { termStats: TermStatsType[], threshold: number }) {
    const renderBarChart = () => {
        let filteredTerms = Object.entries(termStats).filter(([i, term]) => 
            term.correctness*100 >= threshold).map((term) => 
