...
export default class CardGame extends Component {
	...
	<div className="downloadsBg">
		...
		{localStorage.getItem('jwt') === null ? <MainTemplate /> : <Template permission={this.state.permission}/>}
						...
						<h3 className="cardGameText" >ELLE Card Game</h3>
						<p className="cardGameText">Senior Design Team:</p>
						<ul className="cardGameText">
								<li>Justin Moy</li>
								<li>Connor Lysek</li>
								<li>Keilvin Tran</li>
                                <li>Natham Lim</li>
